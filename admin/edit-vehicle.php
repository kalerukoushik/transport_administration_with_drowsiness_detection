						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading" style="background-color:#2c3136; color:white">Basic Info</div>
										...
										<center>
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2" >
													...
													<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%; width:200px;font-size:17px;">Save changes</button>
												</div>
											</div></center>
