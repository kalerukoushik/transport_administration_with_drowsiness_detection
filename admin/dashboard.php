								...
								<div class="row">
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light" style="background-color:#5A69BC;">
...
?>
											...
											<a href="reg-users.php" class="block-anchor panel-footer" align="center">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light" style="background-color:#548B2E;">
												<div class="stat-panel text-center">
												<?php 
...
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalvehicle - 20);?></div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light" style="background-color:#E5343E;">
												<div class="stat-panel text-center">
<?php 
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light" style="background-color:#EF6C00;">
												<div class="stat-panel text-center">
<?php 
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light" style="background-color:#E5343E;">
												<div class="stat-panel text-center">
<?php 
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light" style="background-color:#EF6C00;">
												<div class="stat-panel text-center">
												<?php 
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light" style="background-color:#548B2E;">
												<div class="stat-panel text-center">
<?php 
