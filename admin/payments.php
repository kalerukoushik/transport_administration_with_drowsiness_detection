			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Payments<button type="submit" class="btn btn-primary" style="margin-left:75%; height:50px;"><a href="payment-add.php" style="color:white;margin-top:4%;width:700px;font-size:15px">+ Add Payments</a></button></h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading" style="background-color:#2c3136; color:white">All Payments</div>
