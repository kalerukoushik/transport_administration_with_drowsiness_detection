						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading" style="background-color:#2c3136; color:white">Vehicle Image 1 Details</div>
...
<?php }}?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary"  style="margin-left:50px; width:200px;font-size:17px;" name="update" type="submit">Update</button>
												</div>
											</div>
