      ...
      <div style="margin-top:1250px;">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <input type="text" class="form-control" name="kms" placeholder="Expected Kilometers(kms)" required>
            </div>
            <div class="form-group">
          ...
          <?php if($_SESSION['login'])
              {?>
              <div class="form-group">
                <a href="payment.php"><input type="submit" class="btn"  name="submit" value="Book Now"></a>
              </div>
              <?php } else { ?>
